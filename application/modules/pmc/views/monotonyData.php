					...
					<div class="card-content center">
						<div class="col s12 m12 l12">
							...
							<p style="margin-top:15px">
								<button class="btn red" onClick="showPMCMonth()">PMC Month</button> 
								<button class="btn red" onClick="showPMCYear()">PMC Year</button></p>
						</div>
					</div>          
                </div>
				<div class="col s12 m12 l12 center">
					<div class="col s6 m6 l6">
						<select id="monthPMC" class="optionMid">
							<?php echo $optBulan ?>
						</select>
					</div>  
					<div class="col s6 m6 l6">
						<select id="yearPMC" class="optionMid">
							<?php echo $optTahun ?>
						</select>
					</div>
				</div>
